  ...
  return (
    <div className="flex flex-col items-center justify-center min-h-screen p-4 bg-gradient-to-b from-[#0a0a1a] via-[#1a1a3a] to-[#0a1a2a] overflow-hidden">
      <div className="mb-4 text-center">
        ...
        <p className="text-green-400 text-sm md:text-base tracking-wider">Lướt Sóng Chứng Khoán - Dễ Hơn Trading Thật!</p>
      </div>
      ...
      {gameState === 'menu' && !showLeaderboard && (
         <div className="absolute inset-0 flex flex-col items-center justify-center pointer-events-none">
            <div className="bg-black/80 p-8 rounded-xl border border-green-500 text-center pointer-events-auto backdrop-blur-sm shadow-[0_0_50px_rgba(0,255,136,0.2)]">
                <h2 className="text-4xl text-green-400 mb-6 font-bold tracking-widest">READY TO TRADE?</h2>
                <div className="space-y-4 w-64">
                    <button onClick={startGame} className="w-full py-4 bg-green-500 rounded-lg font-bold text-[#0a1628] text-xl hover:bg-green-400 transition shadow-[0_0_15px_rgba(0,255,136,0.5)]">🚀 BẮT ĐẦU</button>
                    <button onClick={() => setShowLeaderboard(true)} className="w-full py-3 bg-yellow-400 rounded-lg font-bold text-[#0a1628] text-lg hover:bg-yellow-300 transition">🏆 BẢNG XẾP HẠNG</button>
                    <button onClick={() => setSoundEnabled(soundManager.toggle())} className="w-full py-2 bg-gray-800 rounded-lg font-bold text-gray-300 text-sm hover:bg-gray-700 transition border border-gray-600">
      ...
      {showLeaderboard && (
          <div className="absolute inset-0 z-50 flex items-center justify-center bg-black/95">
              <div className="w-full max-w-md p-6 bg-[#1a1a2e] border border-gray-700 rounded-xl shadow-[0_0_50px_rgba(0,0,0,0.8)]">
                  <h2 className="text-3xl text-yellow-400 text-center mb-6 font-bold tracking-wider">TOP TRADERS</h2>
                  ...
                  <button onClick={() => setShowLeaderboard(false)} className="w-full py-3 bg-gray-700 text-white rounded-lg font-bold hover:bg-gray-600 transition text-lg">CLOSE</button>
              </div>
          </div>
      )}
      ...
      {showNameInput && (
          <div className="absolute inset-0 z-50 flex items-center justify-center bg-black/90 backdrop-blur-sm">
             <div className="text-center p-8 bg-[#1a1a2e] border border-green-500 rounded-xl shadow-[0_0_50px_rgba(0,255,136,0.3)]">
                 <h2 className="text-4xl text-yellow-400 mb-2 font-bold">NEW HIGH SCORE!</h2>
                 ...
                 />
                 <p className="text-gray-500 text-sm animate-pulse">Press ENTER to save</p>
             </div>
          </div>
      )}
